        ...
        <div class="w-contain">
            <div class="feature-grid">
                <article class="feature-card">
                    <FeatureCard title="Invest your money in dollars"
                        ...
                        image="/file1.png" imagePosition="left" />
                </article>
                <article class="feature-card">
                    <FeatureCard title="Choose what's best for you"
                        ...
                        image="/file2.png" imagePosition="right" />
                </article>
                <article class="feature-card">
                    <FeatureCard title="Set goals and reach them"
                        ...
                        image="/file3.png" imagePosition="left" />
                </article>
                <article class="feature-card">
                    <FeatureCard title="We remember so you don’t have to"
                        ...
                        image="/file4.png" imagePosition="right" />
                </article>
            </div>
        </div>
    </section>
